...
var helpText = [
	"Karazhan ShapeMaker app by TiggerOni.",
	"v1.0",
	...
	"",
	"This app allows you to click on any two nodes and form a line between them.",
	"",
	"Click on a food name to make the node for that food larger.",
	"Click on a node to select it.  Then click on another node.  Press \'l'\ to make a line.",
	"Shift click on a node to bring all its nodes to the top.",
	"    (Useful if there\'s a node on top that's making it hard to click)",
	"Allow Inactive Swaps allows you to click on a node that's not active/large.",
	"",
	"\'r\' resets the board.",
